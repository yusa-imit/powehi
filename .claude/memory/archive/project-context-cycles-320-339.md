# Powehi project-context.md archive — cycles 320-339

> Moved out of the live `.claude/memory/project-context.md` in cycle 360 (2026-08-25
> STABILIZATION) to keep the live file under the 256KB Read-tool cap, per the precedent
> set in cycles 320 and 340. Read directly (with offset/limit) for this range's detail.
