# Archived project-context.md cycles 372-401

> Moved out of `.claude/memory/project-context.md` in cycle 420 (2026-09-03
> STABILIZATION) — the live file had grown to 3814 lines / 275KB, over the
> Read-tool 256KB cap (hit on the first read attempt that cycle). See
> `.claude/memory/project-context.md` for current state and the index of all
> archive files.
